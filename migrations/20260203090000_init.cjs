...
exports.up = (pgm) => {
  ...
  pgm.createTable('phone_numbers', {
    ...
    send_delay_seconds: { type: 'integer' },
  ...
  pgm.addConstraint('phone_numbers', 'phone_numbers_twilio_number_unique', { unique: ['twilio_number'] });
  ...
  pgm.addConstraint('message_jobs', 'message_jobs_call_sid_unique', { unique: ['call_sid'] });
